...
| 类别 | 交付物 | 状态 |
|------|--------|------|
| 国内 IdP | [domestic-idp-guide.md](domestic-idp-guide.md) + `docs/templates/idp/*` | ✅ 文档 + 模板 |
...
- [x] 飞书 OIDC 联邦配置模板与 Admin API 注册脚本
- [x] 钉钉 / 企业微信接入说明（OIDC Discovery 可用时走联邦；否则 LDAP/本地账号）
...
- [ ] 钉钉 / 企业微信 **非标准 OAuth2** 专用 ClientRegistration（无 Discovery 时手动 endpoint）
